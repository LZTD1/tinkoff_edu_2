...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>public.users.telegramid</code>.
     */
    public final TableField<UsersRecord, Long> TELEGRAMID = createField(DSL.name("telegramid"), SQLDataType.BIGINT.nullable(false), this, "");
    ...
    public List<UniqueKey<UsersRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UNIQUE_TELEGRAMID);
    }
