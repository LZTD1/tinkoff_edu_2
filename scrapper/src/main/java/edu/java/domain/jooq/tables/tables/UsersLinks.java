...
public class UsersLinks extends TableImpl<UsersLinksRecord> {
     ...
     */
    public final TableField<UsersLinksRecord, Long> USERID =
        createField(DSL.name("userid"), SQLDataType.BIGINT.nullable(false), this, "");
    /**
     * The column <code>public.users_links.linkid</code>.
     */
    public final TableField<UsersLinksRecord, Long> LINKID =
        createField(DSL.name("linkid"), SQLDataType.BIGINT.nullable(false), this, "");
